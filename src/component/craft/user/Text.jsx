...
// export const Text = ({ text, fontSize, textAlign, fontWeight, color, lineHeight, charSpacing, margin, padding, width }) => {
...
//         <Input value={props.text} onChange={(e) => setProp((props) => (props.text = e.target.value))} />
...
//         <Input type="color" value={props.color} onChange={(e) => setProp((props) => (props.color = e.target.value))} />

//         <Label>Line Height</Label>
//         <Slider defaultValue={[props.lineHeight]} min={1} max={3} step={0.1} onValueChange={(value) => setProp((props) => (props.lineHeight = value[0]))} />

//         <Label>Character Spacing</Label>
//         <Slider defaultValue={[props.charSpacing]} min={0} max={10} step={0.5} onValueChange={(value) => setProp((props) => (props.charSpacing = value[0]))} />
...
//         <Label>Width</Label> {/* Add a new width input slider or input */}
//         <Slider defaultValue={[props.width]} min={0} max={1000} step={1} onValueChange={(value) => setProp((props) => (props.width = value[0]))} />
//       </CardContent>
//     </Card>
//   );
// };
    ...
    <Card>
      <CardContent className="space-y-4">
        ...
        <div className="space-y-4">
          ...
          <Input
            type="color"
            value={props.colorMobile || props.color}
            onChange={(e) =>
