      ...
      <div ref={(ref) => connect(drag(ref))}>
        <ShadButton
          ...
          style={{
            ...
            "--color-mobile": undefined,

            "--background-color": backgroundColor || theme.colors.secondary.hex,
            "--background-color-mobile": backgroundColorMobile || undefined,
            "--font-family": theme.font.paragraph.family,
        ...
        <Accordion type="single" collapsible>
          <AccordionItem value="desktop">
            ...
            <AccordionContent className="space-y-4">
              ...
              <ColorPicker
                value={props.backgroundColor || theme.colors.primary.hex}
