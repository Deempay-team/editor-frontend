...
export const NewsletterSettings_2 = () => {
    ...
    <div className="bg-white space-y-6">
      ...
      <Section title="Layout" className=" border-b border-gray-200 pb-5">
        ...
        {isDesktop && (
          <div className=" flex items-center justify-between w-full transition-all duration-1000 ease-in-out">
            <Label className="w-[30%]">
              {props.desktopDirection === "vertical" ? "Alignment" : "Position"}
            </Label>
            <Tabs
        ...
        {isDesktop && (
          <div className=" flex items-center justify-between w-full transition-all duration-1000 ease-in-out">
            <Label className="w-[30%]">
              {props.desktopDirection === "vertical" ? "Position" : "Alignment"}
            </Label>
            {props.desktopDirection === "vertical" ? (
              <Tabs
        ...
        <SliderControl
          value={isDesktop ? props.gapDesktop : props.gapMobile}
          label="Gap"
          onChange={(val) =>
            setProp((p) =>
              isDesktop ? (p.gapDesktop = val) : (p.gapMobile = val)
            )
          }
        />
      ...
      <Section title="Padding" className="mb-4">
        ...
        <SliderControl
          value={
            isDesktop ? props.borderRadiusDesktop : props.borderRadiusMobile
          }
          label="Border Radius"
          min={0}
          max={100}
          ...
          onChange={(val) =>
            setProp((p) =>
              isDesktop
                ? (p.borderRadiusDesktop = val)
                : (p.borderRadiusMobile = val)
            )
          }
        />
