...
export const DecreaseButton = ({ iconSize, iconColor, ...props }) => {
    const {
...
export const DecreaseButtonSettings = () => {
...
DecreaseButton.craft = {
    displayName: "Decrease Icon",
    props: {
        iconSize: 17,
        iconColor: "#FF4D00",
    },
    ...
    related: {
        settings: DecreaseButtonSettings,
    },
};
