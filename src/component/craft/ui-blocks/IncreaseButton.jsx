...
export const IncreaseButton = ({ iconSize, iconColor, ...props }) => {
    const {
...
export const IncreaseButtonSettings = () => {
...
IncreaseButton.craft = {
    displayName: "Increase Icon",
    props: {
        iconSize: 17,
        iconColor: "#FF4D00",
    },
    ...
    related: {
        settings: IncreaseButtonSettings,
    },
};