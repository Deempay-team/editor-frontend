...
export const Logo = ({
    ...
    const renderLogoContent = () => {
        ...
        return <span style={{color: "#000000", fontWeight: 700, fontSize: "16px"}}>Logo</span>;
    };
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="flex items-center gap-2">
                                <Slider
                                    ...
                                    max={60}
                                    step={1}
                                    onValueChange={(v) => setProp((p) => (p.logoImageHeight = `${v[0]}px`))}
                                    disabled={!props.logoSrc}
                                />
                                <Input
                                    type="number"
                                    ...
                                    onChange={(e) => setProp((p) => (p.logoImageHeight = `${parseInt(e.target.value)}px`))}
                                    disabled={!props.logoSrc}
                                />
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="flex items-center gap-2">
                                <Slider
                                    ...
                                    max={50}
                                    step={1}
                                    onValueChange={(v) => setProp((p) => (p.logoImageBorderRadius = v[0]))}
                                    disabled={!props.logoSrc}
                                />
                                <Input
                                    type="number"
                                    ...
                                    onChange={(e) => setProp((p) => (p.logoImageBorderRadius = parseInt(e.target.value)))}
                                    disabled={!props.logoSrc}
                                />
                                <span className="text-sm text-gray-500">px</span>
                            </div>
