...
export const NavigationBarSettings = () => {
  ...
  const ColorPicker =
    (window.ReactColorful && window.ReactColorful.HexColorPicker) ||
    (({ color, onChange }) => (
      <Input
        type="color"
        value={color}
    ...
    <Card>
      <CardContent className="space-y-4 mt-4">
        ...
        <Slider
          ...
          step={1}
          onValueChange={(value) =>
            setProp((props) => (props.paddingX = value[0]))
          }
        />
        ...
        <Slider
          ...
          step={1}
          onValueChange={(value) =>
            setProp((props) => (props.paddingY = value[0]))
          }
        />
        ...
        <div className="flex items-center justify-between">
          ...
          <Switch
            ...
            onCheckedChange={(checked) =>
              setProp((props) => (props.wrap = checked))
            }
          />
        </div>
        ...
        <Input
          value={logoSrc}
          onChange={(e) => setProp((props) => (props.logoSrc = e.target.value))}
          placeholder="https://..."
        />
        <Label>Logo Alt Text</Label>
        <Input
          value={logoAlt}
          onChange={(e) => setProp((props) => (props.logoAlt = e.target.value))}
        ...
        <Slider
          ...
          step={5}
          onValueChange={(value) =>
            setProp((props) => (props.logoWidth = value[0]))
          }
        />
        ...
        <Slider
          ...
          step={5}
          onValueChange={(value) =>
            setProp((props) => (props.logoHeight = value[0]))
          }
        />
        ...
        <Input
          value={logoLink}
          onChange={(e) =>
            setProp((props) => (props.logoLink = e.target.value))
          }
          placeholder="https://..."
        />
        ...
        <div className="flex items-center justify-between">
          ...
          <Switch
            ...
            onCheckedChange={(checked) =>
              setProp((props) => (props.showCtaButton = checked))
            }
          />
        </div>
        ...
        {showCtaButton && (
          <>
            ...
            <Input
              value={ctaButtonText}
              onChange={(e) =>
                setProp((props) => (props.ctaButtonText = e.target.value))
              }
            />
            ...
            <Input
              value={ctaButtonLink}
              onChange={(e) =>
                setProp((props) => (props.ctaButtonLink = e.target.value))
              }
              placeholder="https://..."
            />
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={(checked) =>
                  setProp((props) => (props.ctaOpenInNewTab = checked))
                }
              />
            </div>
          </>
