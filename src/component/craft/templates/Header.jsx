  ...
  return (
    <div style={{ padding: "10px" }}>
      ...
      <input
        type="text"
        value={logoText}
        onChange={(e) => setProp((props) => (props.logoText = e.target.value), 500)}
      />
      ...
      <input
        type="color"
        value={bgColor}
        onChange={(e) => setProp((props) => (props.bgColor = e.target.value), 500)}
      />
      ...
      <input
        type="color"
        value={textColor}
        onChange={(e) => setProp((props) => (props.textColor = e.target.value), 500)}
      />
      ...
      <div style={{ marginTop: "10px" }}>
        <label>
          <input
            type="checkbox"
            checked={fullWidth}
            onChange={(e) => setProp((props) => (props.fullWidth = e.target.checked), 500)}
          />
          Full Width
        </label>
      </div>
