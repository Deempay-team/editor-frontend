...
import { ContentSect, ContentSectionSect } from "../component/craft/ContentSect"
...
export default function PageBuilder() {
  ...
  return (
    <>
      <Editor enabled={true}  resolver={{ Card, Button, Text, Container, CardTop, CardBottom, Image, Column, AnnouncementBar, NavigationBar, Grid }}>
        <ViewportProvider>
