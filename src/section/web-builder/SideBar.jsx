        ...
        <div className=''>
            <div className='flex flex-col items-center w-18 h-screen bg-white border-r border-gray-200'>
                ...
                <nav className='flex flex-1 flex-col gap-y-4 pt-10'>
                    ...
                    <a className='group relative rounded-xl bg-gray-100 p-2 text-blue-600 hover:bg-gray-50' href=''>
                        <SquarePlusIcon className='h-6 w-6 stroke-current' />
                        <Tooltip>Add element <span className='text-gray-400'>  (A) </span></Tooltip>
                    </a>

                    <a className='group relative rounded-xl p-2 text-gray-400 hover:bg-gray-100' href='#'>
